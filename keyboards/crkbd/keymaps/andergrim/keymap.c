...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x6_3(
              KC_TAB,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,     KC_7, KC_8, KC_9, KC_PSLS, KC_MINS, KC_BSPC,
              KC_ESC, GUI__A, ALT__R, SFT__S, CTL__T, KC_NO,     KC_4, KC_5, KC_6, KC_PAST, KC_NO,   KC_DEL,
             KC_LSFT,  KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO,     KC_1, KC_2, KC_3, KC_DOT,  KC_SLSH, KC_RSFT,
                                       TT(4), MO(1), KC_SPC,     KC_ENT, KC_0, KC_LALT
    )
};
